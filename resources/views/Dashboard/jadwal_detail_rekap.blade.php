...
<div class="bg-white min-h-screen p-4 sm:p-6 lg:p-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-blue-50 rounded-lg p-6">
            ...
            <!-- Download Button -->
            <div class="mb-6">
                <button class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-semibold transition flex items-center gap-2">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @php
                            $students = [
                                ['name' => 'NAMA MAHASISWA', 'nim' => '3337240004', 'count' => 7, 'percent' => '88%', 'status' => ['Hadir', 'Tidak Hadir', 'Sakit', 'Hadir', 'Hadir', 'Hadir', 'Hadir']],
                                ['name' => 'NAMA MAHASISWA', 'nim' => '3337240004', 'count' => 6, 'percent' => '75%', 'status' => ['Tidak Hadir', 'Hadir', 'Hadir', 'Sakit', 'Hadir', 'Hadir', 'Hadir']],
                                ['name' => 'NAMA MAHASISWA', 'nim' => '3337240004', 'count' => 8, 'percent' => '75%', 'status' => ['Tidak Hadir', 'Sakit', 'Hadir', 'Izin', 'Hadir', 'Hadir', 'Hadir']],
                                ['name' => 'NAMA MAHASISWA', 'nim' => '3337240004', 'count' => 8, 'percent' => '100%', 'status' => ['Hadir', 'Hadir', 'Hadir', 'Hadir', 'Hadir', 'Hadir', 'Hadir']],
                                ['name' => 'NAMA MAHASISWA', 'nim' => '3337240004', 'count' => 8, 'percent' => '100%', 'status' => ['Hadir', 'Hadir', 'Hadir', 'Hadir', 'Hadir', 'Hadir', 'Hadir']],
                            ];
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-3 py-3">
                                    ...
                                    <div class="text-xs text-white bg-blue-600 rounded px-2 py-1 inline-block mt-1">{{ $student['nim'] }}</div>
                                </td>
                                <td class="px-3 py-3 text-center font-semibold">{{ $student['count'] }}</td>
                                <td class="px-3 py-3 text-center">
                                    <span class="bg-green-100 text-green-800 px-3 py-1 rounded-full font-semibold">{{ $student['percent'] }}</span>
                                </td>
