        ...
        <div class="bg-blue-50 rounded-lg p-6">
            ...
            <div class="bg-white rounded-lg p-6 mb-6">
                ...
                <div class="flex items-center justify-between bg-blue-50 p-4 rounded-lg border-2 border-blue-200">
                    ...
                    <a href="#" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-semibold transition flex items-center gap-2">
                    ...
                    <table class="w-full">
                        <thead class="bg-blue-100">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left text-sm font-semibold text-gray-900">Metode Penyampaian</th>
                                <th class="px-4 py-3 text-left text-sm font-semibold text-gray-900">Alokasi Waktu</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-200">
                            @php
                            $materials = [
                                ['KONSEP DASAR WEB', 'Tut', '1 Tut : 6 menit, 2 Praktek : 50 menit, 3 Kegiatan : 55 menit'],
                                ...
                                ['Operator', 'Tut', '1 Tut : 6 menit, 2 Praktek : 50 menit, 3 Kegiatan : 55 menit'],
                                ['PENGGUNAAN FORM DAN PENGGUNAAN HTTP SERVER', 'Tut', '1 Tut : 6 menit, 2 Praktek : 50 menit, 3 Kegiatan : 55 menit'],
                                ['PERCABANGAN', 'Tut', '1 Tut : 6 menit, 2 Praktek : 50 menit, 3 Kegiatan : 55 menit'],
                                ['PERULANGAN', 'Tut', '1 Tut : 6 menit, 2 Praktek : 50 menit, 3 Kegiatan : 55 menit'],
                                ['JAVASCRIPT', 'Tut', '1 Tut : 6 menit, 2 Praktek : 50 menit, 3 Kegiatan : 55 menit'],
                                ['CSS', 'Tut', '1 Tut : 6 menit, 2 Praktek : 50 menit, 3 Kegiatan : 55 menit'],
                                ['MEMBUAT DESAINER WEB RESPONSIVE MENGGUNAKAN CSS', 'Tut', '1 Tut : 6 menit, 2 Praktek : 50 menit, 3 Kegiatan : 55 menit'],
                            ];
                            @endphp
                            @foreach($materials as $index => $material)
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-4 text-sm">{{ $index + 1 }}</td>
                                <td class="px-4 py-4 text-sm text-gray-700">Mahasiswa mampu menguasai keseharian pemrograman website</td>
                                <td class="px-4 py-4 text-sm font-semibold text-gray-900">{{ $material[0] }}</td>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead class="bg-blue-100">
                                <tr>
                                    <th class="px-4 py-3 text-left text-sm font-semibold text-gray-900">No</th>
                                    <th class="px-4 py-3 text-left text-sm font-semibold text-gray-900">Aspek Evaluasi</th>
                                    <th class="px-4 py-3 text-left text-sm font-semibold text-gray-900">Rencana Evaluasi</th>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                @php
                                $evaluations = [
                                    ['Afektifitas (Variasi)', '10. Kehadiran refleksif di kelas dalam pembelajaran mata pembelajaran, 20. Tugas dalam mengembangkan pembelajaran, serta keterlibatan dalam satu mata kegiatan dengan kehadiran, 30. Keterlibatan dalam kelas dengan presentasi.', '5'],
                                    ['Unsur Projek', 'Implementasi hasil pembelajaran berupa produk aplikasi', '32'],
                                    ['Target', 'Nilai Target ditentukan dalam aktivitas pertemuan', '0'],
                                    ['Quiz', 'Nilai Quiz ditentukan dalam aktivitas pertemuan', '0'],
                                    ['Ujian Tengah Semester', 'Pengujian kompetensi tertentu, yang dilaksanakan secara terpadu.', '3'],
                                    ['Ujian Akhir Semester', 'Pengujian kompetensi tertentu, yang dilaksanakan secara terpadu.', '3'],
                                ];
                                @endphp
                                @foreach($evaluations as $index => $eval)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-4 py-4 text-sm">{{ $index + 1 }}</td>
                                    <td class="px-4 py-4 text-sm font-semibold text-gray-900">{{ $eval[0] }}</td>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead class="bg-blue-100">
                                <tr>
                                    <th class="px-4 py-3 text-left text-sm font-semibold text-gray-900">No</th>
                                    <th class="px-4 py-3 text-left text-sm font-semibold text-gray-900">Referensi</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-200">
                                <tr class="hover:bg-gray-50">
                                    <td class="px-4 py-4 text-sm">1</td>
                                    <td class="px-4 py-4 text-sm text-gray-700">Lumenta, R. (2019). WEBSITE STATIS Ebook dan Poster HTML - CSS di website bahasa contoh pada projek final - css (p 1)</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
