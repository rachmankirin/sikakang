                        ...
                        <tbody class="divide-y divide-yellow-100">
                            @forelse ($jadwalHariIni as $index => $krs)
                                <tr class="text-center hover:bg-yellow-50/60 transition-colors">
                                    ...
                                    <td class="border border-yellow-200 px-1 sm:px-2 py-1">{{ $krs->kelas->mataKuliah->sks ?? 0 }}</td>
                                    <td class="border border-yellow-200 px-1 sm:px-2 py-1">{{ $krs->kelas->jam_mulai ?? '-' }}–{{ $krs->kelas->jam_selesai ?? '-' }}</td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="4" class="border border-yellow-200 px-1 sm:px-2 py-4 text-center text-gray-500">
                                        <i class="fa-solid fa-calendar-xmark text-gray-400 mr-2"></i>
