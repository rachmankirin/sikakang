    ...
    <body class="bg-gray-50">
        ...
        <div class="p-4 sm:p-6 bg-gray-50 min-h-screen">
            <div class="max-w-7xl mx-auto">
                <div
                    class="col-span-12 bg-gradient-to-r from-yellow-400 to-yellow-300 text-center text-gray-800 font-bold p-6 rounded-2xl shadow-lg mb-8">
                ...
                <div class="btn p-5 flex justify-end">
                    <button id="openModalBtn"
                        class="px-3 py-2 bg-yellow-500 text-white hover:bg-yellow-600 rounded-lg font-semibold mb-10 transition-colors">
                        Tambah Fakultas
                    </button>
                </div>
                ...
                <div class="mb-12">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div class="fakultas-card rounded-xl shadow-sm border border-gray-200 p-6 transition-smooth hover-scale"
                            style="border-left-color: #3b82f6;">
                            <div class="flex justify-between items-start mb-4">
                                <div>
                                    <h3 class="text-xl font-bold text-gray-800 mb-2">Fakultas Keguruan dan Ilmu
                                        Pendidikan</h3>
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-200">
                                ...
                                <ul class="text-sm text-gray-600 space-y-1">
                                    ...
                                    <li>
                                        <a href="/fakultas/fkip/pendidikan-fisika"
                                            class="prodi-link text-blue-600 hover:text-blue-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Pendidikan Fisika
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/fkip/pendidikan-pancasila"
                                            class="prodi-link text-blue-600 hover:text-blue-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Pendidikan Pancasila dan
                                            Kewarganegaraan
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/fkip/pendidikan-seni"
                                            class="prodi-link text-blue-600 hover:text-blue-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Pendidikan Seni dan
                                            Pertunjukan
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/fkip/pendidikan-sejarah"
                                            class="prodi-link text-blue-600 hover:text-blue-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Pendidikan Sejarah
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/fkip/pendidikan-vokasi-elektro"
                                            class="prodi-link text-blue-600 hover:text-blue-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Pendidikan Vokasi Teknik
                                            Elektro
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/fkip/pendidikan-bahasa-indonesia"
                                            class="prodi-link text-blue-600 hover:text-blue-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Pendidikan Bahasa Indonesia
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/fkip/pendidikan-paud"
                                            class="prodi-link text-blue-600 hover:text-blue-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Pendidikan Guru Pendidikan
                                            Anak Usia Dini
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/fkip/pendidikan-ipa"
                                            class="prodi-link text-blue-600 hover:text-blue-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Pendidikan IPA
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/fkip/pendidikan-khusus"
                                            class="prodi-link text-blue-600 hover:text-blue-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Pendidikan Khusus
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/fkip/pendidikan-vokasi-mesin"
                                            class="prodi-link text-blue-600 hover:text-blue-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Pendidikan Vokasi Teknik
                                            Mesin
                                        </a>
                            ...
                            <div class="mt-6 flex justify-between">
                                <span
                                    class="px-3 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">Akreditasi
                                    A</span>
                                <a href="/fakultas/fkip"
                        ...
                        <div class="fakultas-card rounded-xl shadow-sm border border-gray-200 p-6 transition-smooth hover-scale"
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-200">
                                ...
                                <ul class="text-sm text-gray-600 space-y-1">
                                    <li>
                                        <a href="/fakultas/teknik/teknik-industri"
                                            class="prodi-link text-red-600 hover:text-red-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Teknik Industri
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/teknik/teknik-kimia"
                                            class="prodi-link text-red-600 hover:text-red-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Teknik Kimia
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/teknik/teknik-elektro"
                                            class="prodi-link text-red-600 hover:text-red-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Teknik Elektro
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/teknik/teknik-mesin"
                                            class="prodi-link text-red-600 hover:text-red-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Teknik Mesin
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/teknik/teknik-sipil"
                                            class="prodi-link text-red-600 hover:text-red-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Teknik Sipil
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/teknik/informatika"
                                            class="prodi-link text-red-600 hover:text-red-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Informatika
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/teknik/statistika"
                                            class="prodi-link text-red-600 hover:text-red-800 hover:underline flex items-center">
                            ...
                            <div class="mt-6 flex justify-between">
                                <span
                                    class="px-3 py-1 bg-red-100 text-red-800 text-xs font-medium rounded-full">Akreditasi
                                    A</span>
                                <a href="/fakultas/teknik"
                        ...
                        <div class="fakultas-card rounded-xl shadow-sm border border-gray-200 p-6 transition-smooth hover-scale"
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-200">
                                ...
                                <ul class="text-sm text-gray-600 space-y-1">
                                    <li>
                                        <a href="/fakultas/pertanian/agroteknologi"
                                            class="prodi-link text-green-600 hover:text-green-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Agroteknologi
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/pertanian/agribisnis"
                                            class="prodi-link text-green-600 hover:text-green-800 hover:underline flex items-center">
                                    ...
                                    <li>
                                        <a href="/fakultas/pertanian/teknologi-pangan"
                                            class="prodi-link text-green-600 hover:text-green-800 hover:underline flex items-center">
                            ...
                            <div class="mt-6 flex justify-between">
                                <span
                                    class="px-3 py-1 bg-green-100 text-green-800 text-xs font-medium rounded-full">Akreditasi
                                    A</span>
                                <a href="/fakultas/pertanian"
                        ...
                        <div class="fakultas-card rounded-xl shadow-sm border border-gray-200 p-6 transition-smooth hover-scale"
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-200">
                                ...
                                <ul class="text-sm text-gray-600 space-y-1">
                                    <li>
                                        <a href="/fakultas/ekonomi/manajemen"
                                            class="prodi-link text-yellow-600 hover:text-yellow-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Manajemen
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/ekonomi/akuntansi"
                                            class="prodi-link text-yellow-600 hover:text-yellow-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Akuntansi
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/ekonomi/ekonomi-pembangunan"
                                            class="prodi-link text-yellow-600 hover:text-yellow-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Ekonomi Pembangunan
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/ekonomi/ekonomi-syariah"
                                            class="prodi-link text-yellow-600 hover:text-yellow-800 hover:underline flex items-center">
                            ...
                            <div class="mt-6 flex justify-between">
                                <span
                                    class="px-3 py-1 bg-yellow-100 text-yellow-800 text-xs font-medium rounded-full">Akreditasi
                                    A</span>
                                <a href="/fakultas/ekonomi"
                        ...
                        <div class="fakultas-card rounded-xl shadow-sm border border-gray-200 p-6 transition-smooth hover-scale"
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-200">
                                ...
                                <ul class="text-sm text-gray-600 space-y-1">
                                    <li>
                                        <a href="/fakultas/hukum/ilmu-hukum"
                                            class="prodi-link text-purple-600 hover:text-purple-800 hover:underline flex items-center">
                            ...
                            <div class="mt-6 flex justify-between">
                                <span
                                    class="px-3 py-1 bg-purple-100 text-purple-800 text-xs font-medium rounded-full">Akreditasi
                                    A</span>
                                <a href="/fakultas/hukum"
                        ...
                        <div class="fakultas-card rounded-xl shadow-sm border border-gray-200 p-6 transition-smooth hover-scale"
                            ...
                            <div class="flex justify-between items-start mb-4">
                                <div>
                                    <h3 class="text-xl font-bold text-gray-800 mb-2">Fakultas Ilmu Sosial dan Politik
                                    </h3>
                                    <div class="flex items-center text-sm text-gray-600 mb-1">
                                        <i class="fas fa-graduation-cap mr-2"></i>
                                        <span>Jenjang: S1</span>
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-200">
                                ...
                                <ul class="text-sm text-gray-600 space-y-1">
                                    <li>
                                        <a href="/fakultas/isipol/ilmu-pemerintahan"
                                            class="prodi-link text-pink-600 hover:text-pink-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Ilmu Pemerintahan
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/isipol/ilmu-komunikasi"
                                            class="prodi-link text-pink-600 hover:text-pink-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Ilmu Komunikasi
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/isipol/administrasi-negara"
                                            class="prodi-link text-pink-600 hover:text-pink-800 hover:underline flex items-center">
                            ...
                            <div class="mt-6 flex justify-between">
                                <span
                                    class="px-3 py-1 bg-pink-100 text-pink-800 text-xs font-medium rounded-full">Akreditasi
                                    A</span>
                                <a href="/fakultas/isipol"
                                    class="text-pink-600 hover:text-pink-800 font-medium text-sm flex items-center">
                                    Kelola <i class="fas fa-chevron-right ml-1 text-xs"></i>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="fakultas-card rounded-xl shadow-sm border border-gray-200 p-6 transition-smooth hover-scale"
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-200">
                                ...
                                <ul class="text-sm text-gray-600 space-y-1">
                                    <li>
                                        <a href="/fakultas/kedokteran/pendidikan-dokter"
                                            class="prodi-link text-cyan-600 hover:text-cyan-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Pendidikan Dokter
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/kedokteran/gizi"
                                            class="prodi-link text-cyan-600 hover:text-cyan-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Gizi
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/kedokteran/pendidikan-olahraga"
                                            class="prodi-link text-cyan-600 hover:text-cyan-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Pendidikan Olahraga
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/fakultas/kedokteran/keperawatan"
                                            class="prodi-link text-cyan-600 hover:text-cyan-800 hover:underline flex items-center">
                            ...
                            <div class="mt-6 flex justify-between">
                                <span
                                    class="px-3 py-1 bg-cyan-100 text-cyan-800 text-xs font-medium rounded-full">Akreditasi
                                    A</span>
                                <a href="/fakultas/kedokteran"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                        <div class="fakultas-card rounded-xl shadow-sm border border-gray-200 p-6 transition-smooth hover-scale"
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-200">
                                ...
                                <ul class="text-sm text-gray-600 space-y-1">
                                    <li>
                                        <a href="/pascasarjana/magister-hukum"
                                            class="prodi-link text-gray-600 hover:text-gray-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Magister Ilmu Hukum
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/pascasarjana/magister-akuntansi"
                                            class="prodi-link text-gray-600 hover:text-gray-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Magister Ilmu Akuntansi
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/pascasarjana/magister-pendidikan-bahasa-inggris"
                                            class="prodi-link text-gray-600 hover:text-gray-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Magister Pendidikan Bahasa
                                            Inggris
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/pascasarjana/magister-ilmu-komunikasi"
                                            class="prodi-link text-gray-600 hover:text-gray-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Magister Ilmu Komunikasi
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/pascasarjana/magister-ilmu-pertanian"
                                            class="prodi-link text-gray-600 hover:text-gray-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Magister Ilmu Pertanian
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/pascasarjana/magister-administrasi-publik"
                                            class="prodi-link text-gray-600 hover:text-gray-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Magister Administrasi Publik
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/pascasarjana/magister-pendidikan-matematika"
                                            class="prodi-link text-gray-600 hover:text-gray-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Magister Pendidikan
                                            Matematika
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/pascasarjana/magister-pendidikan-bahasa-indonesia"
                                            class="prodi-link text-gray-600 hover:text-gray-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Magister Pendidikan Bahasa
                                            Indonesia
                                        </a>
                                    ...
                                    <li>
                                        <a href="/pascasarjana/magister-teknik-kimia"
                                            class="prodi-link text-gray-600 hover:text-gray-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Magister Teknik Kimia
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/pascasarjana/magister-manajemen"
                                            class="prodi-link text-gray-600 hover:text-gray-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Magister Manajemen
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/pascasarjana/magister-teknologi-pendidikan"
                                            class="prodi-link text-gray-600 hover:text-gray-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Magister Teknologi
                                            Pendidikan
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <ul class="text-sm text-gray-600 space-y-1">
                                    <li>
                                        <a href="/pascasarjana/doktor-ilmu-pendidikan"
                                            class="prodi-link text-gray-600 hover:text-gray-800 hover:underline flex items-center">
                                            <i class="fas fa-arrow-right mr-2 text-xs"></i>Doktor Ilmu Pendidikan
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/pascasarjana/doktor-ilmu-akuntansi"
                                            class="prodi-link text-gray-600 hover:text-gray-800 hover:underline flex items-center">
                            ...
                            <div class="mt-6 flex justify-between">
                                <span
                                    class="px-3 py-1 bg-gray-100 text-gray-800 text-xs font-medium rounded-full">Akreditasi
                                    A</span>
                                <a href="/pascasarjana"
        ...
        <div id="add-fakultas-modal"
            class="fixed inset-0 bg-gray-900 bg-opacity-50 z-50 flex justify-center items-center hidden">
            <div class="bg-white rounded-lg shadow-xl w-full max-w-lg m-4 transition-transform transform scale-100">
                <div class="p-5 border-b border-gray-200 flex justify-between items-center">
                    <h3 class="text-xl font-bold text-gray-800">Tambah Fakultas Baru</h3>
                    <button id="closeModalBtn" class="text-gray-400 hover:text-gray-600">
                        <i class="fas fa-times text-lg"></i>
                    </button>
                </div>

                <form action="/dashboard-admin/fakultas" method="POST">
                    @csrf
                    <div class="p-5">
                        <div class="mb-4">
                            <label for="fakultas" class="block text-sm font-medium text-gray-700 mb-1">Nama
                                Fakultas</label>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const modal = document.getElementById('add-fakultas-modal');

                function openModal() {
                    modal.classList.remove('hidden');
                    // Tambahkan kelas untuk animasi masuk (opsional)
                    // modal.querySelector('div:first-child').classList.add('animate-scale-in');
                }

                function closeModal() {
                    // Hapus kelas untuk animasi masuk jika ada
                    // modal.querySelector('div:first-child').classList.remove('animate-scale-in');
                    modal.classList.add('hidden');
                }

                // Buka modal saat tombol "Tambah Fakultas" diklik
