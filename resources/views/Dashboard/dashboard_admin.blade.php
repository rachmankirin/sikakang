            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="flex items-center space-x-2">
                    <div class="flex flex-col items-end">
                        <span class="text-sm font-medium text-gray-700">{{ Auth::user()->nama_lengkap ?? 'Mahasiswa' }}</span>
            ...
            <div class="col-span-12 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 transition-smooth hover-scale">
                    ...
                    <div class="flex justify-between items-end">
                        ...
                        <a href="/admin/mahasiswa" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">
                            Kelola
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 transition-smooth hover-scale">
                    ...
                    <div class="flex justify-between items-end">
                        ...
                        <a href="/dashboard-admin/dosen" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">
                            Kelola
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 transition-smooth hover-scale">
                    ...
                    <div class="flex justify-between items-end">
                        ...
                        <a href="/admin/fakultas" class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">
                            Kelola
                        </a>
                    </div>
                </div>
